                                        ...
                                        <div class="a-row a-spacing-top-base a-spacing-base">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8 col-8">
                                                    ...
                                                    <div>
                                                        <span
                                                            class="a-size-small a-color-secondary sc-product-binding">Paperback</span>
                                                    </div>
                                                    <div>
                                                        <span
                                                            class="a-size-small a-color-success sc-product-availability">In
                                                            Stock</span>
                                                    </div>
                                                ...
                                                <div class="col-sm-2 col-2 tr sm-txt-r">
                                                    ...
                                                    <p class="a-spacing-small">
                                                        <span
                                                            class="a-size-medium a-color-price sc-price sc-white-space-nowrap sc-product-price sc-price-sign a-text-bold">${{ product.price * product.quantity }}.00</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <span class="a-list-item">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8 col-sm-9 col-9">
                                                            ...
                                                            <div class="a-size-small">
                                                                <span class="a-size-small a-color-secondary">Kindle
                                                                    Edition</span>
                                                            </div>
                                                            <div class="a-spacing-top-micro">
                                                                <span
                                                                    ...
                                                                    <span class="a-button-inner">
                                                                        <a href="#" class="a-button-text">See all buying
                                                                            options</a>
                                                                    </span>
                                                                </span>
                                                            </div>
