                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="a-section">
                            ...
                            <div class="a-section a-spacing-none a-spacing-top-small">
                                <b>
                                    Or pick up your packages at your convenience from our self-service locations. To add an
                                    Amazon Pickup Point or Locker, click
                                    <a href="#">here</a>.
                                </b>
                            </div>
                            <!-- Error Message -->
                            ...
                            <form>
                                <div class="a-spacing-medium a-spacing-top-medium">
                                    ...
                                    <div class="a-spacing-top-medium">
                                        ...
                                        <input type="number" class="a-input-text" style="width: 100%;" v-model="zipCode"
                                    ...
                                    <div class="a-spacing-top-medium">
                                        <label style="margin-bottom: 0px;">Do we need additional instructions to find this
                                            address?</label>
                                        <textarea
                                    ...
                                    <!-- Security code -->
                                    <div class="a-spacing-top-medium">
                                        <label style="margin-bottom: 0px;">Do we need a security code or a call box number
                                            to access this building?</label>
                                        <input type="text" class="a-input-text" style="width: 100%;"
                                    ...
                                    <div>
                                        <span>If the address contains typos or other errors, your package may be
                                            undeliverable.</span>
                                    </div>
...
export default {
    async asyncData({ $axios, params }) {
        try {
            ...
            const [countries, address] = await Promise.all([countriesResponse, addressResponse])

            console.log("countries is or are ", countries)
            console.log("update is or are ", address)
            return {
                countries: countries,
