                    ...
                    <div class="a-row">
                      <div class="displayAddressDiv">
                        ...
                        <!-- <ul class="displayAddressUL">
                          ...
                          <li>country: {{ $auth.$state.user.address.country }}</li>
                          <li>
                            Phone:
...
export default {
  ...
  async asyncData({$axios, store}){
    ...
    try {
      let response = await $axios.$post("/api/shipment", data);
      console.log("shipping", response.shipment)
  ...
  methods : {
    async onChooseShipping(shipment){
       ...
       try {
        let response = await this.$axios.$post("/api/shipment", data);
